  ...
  return (
    <main className="min-h-screen bg-[#f3ebe6] px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-7xl space-y-8">
          ...
          {heroRestaurant ? (
            <div className="absolute bottom-5 left-1/2 w-[calc(100%-2.5rem)] max-w-2xl -translate-x-1/2 rounded-3xl border border-[#ded2cb] bg-white/95 p-4 shadow-[0_22px_36px_-26px_rgba(84,67,59,0.46)] backdrop-blur sm:p-5">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-[#8d6c61]">#1 Top Rated Restaurant</p>
                  <h2 className="text-2xl leading-tight font-bold text-[#2f2520]">{heroRestaurant.name}</h2>
                  <p className="inline-flex items-center gap-1.5 text-sm text-[#8e7a72]">
                ...
                <div className="text-right">
                  ...
                  <p className="text-xs text-[#a18a80]">{heroRestaurant.totalReviews} reviews</p>
        ...
        <section id="all-restaurants" className="rounded-[34px] border border-[#e5dad3] bg-[#f8f4f1] p-5 sm:p-7">
          <SectionTitle
