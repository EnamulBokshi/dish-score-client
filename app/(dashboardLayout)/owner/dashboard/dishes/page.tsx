...
import OwnerDishManagementTable from "@/components/modules/dish/OwnerDishManagementTable";
import { getMyDishes } from "@/services/dish.services";

interface OwnerDishManagementPageProps {
...
export default async function OwnerDishManagementPage({
	searchParams,
}: OwnerDishManagementPageProps) {
