...
export default function HowItWorksSection() {
  return (
    <HomeSectionFrame
      ...
      cardClassName="border-[#e7d4b4] bg-[#fff9ef]/96 shadow-[0_28px_62px_-46px_rgba(171,121,49,0.35)] dark:border-neon-gold/35 dark:bg-black/45 dark:shadow-[0_30px_75px_-42px_rgba(255,209,102,0.55)]"
